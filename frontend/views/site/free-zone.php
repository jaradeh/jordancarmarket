        ...
        <div class='row'>
            <div class='col-lg-12 col-xs-12'>
                <div class="col-lg-12 col-xs-12" data-wow-delay="0.5s">
                    <a href="/" class="b-breadCumbs__page"><?= yii::t('app', 'home') ?></a><span class="fa fa-angle-right"></span><a href="/" class="b-breadCumbs__page m-active"><?= yii::t('app', "Free Zone's Cars") ?></a>
                </div>
            </div>
...
<section>
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-xs-12" data-waypoint-scroll="true">
                <img src="/media/banners/banner2.jpg" class="img-responsive" style="padding-top: 10px;">
            </div>
        </div>
    </div>
</section><!--b-count-->

<section class="b-brands s-shadow" style="padding-top:40px;">
    <div class='container'>
        <div class="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
            <h2 style='margin:0px;'><?= yii::t('app', 'Duty Free Zone (Al Zarqa\'a)') ?></h2>
        </div>
    </div>
                ...
                <?php foreach ($select_stores as $stores => $store) { ?>
                    <div class="col-sm-6">
                        ...
                        <div class="brdr bgc-fff pad-10 box-shad btm-mrg-20 property-listing">
                            <div class="media">
                                <a class="pull-left" href="/stores/<?php echo $store->slug ?>" target="_parent">
                                    <img alt="<?php echo $store->name ?>" class="img-responsive" src="/media/stores_logo_150x150/<?php echo $store->path ?>"></a>

                                <div class="clearfix visible-sm"></div>

                                <div class="media-body fnt-smaller">
                                    <a href="/stores/<?php echo $store->slug ?>" target="_parent"></a>

                                    <h4 class="media-heading top-padding-10">
                                        <a href="/stores/<?php echo $store->slug ?>" target="_parent"><?php echo $store->name ?></a>
                                    </h4>
                                    ...
                                    <div class="b-footer__content-social" style='text-align: center;margin-top: 10px;'>
