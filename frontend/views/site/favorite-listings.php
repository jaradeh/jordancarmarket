                ...
                <div class="b-items__cars">
                    ...
                    <div class="b-items__cars-one wow zoomInUp" data-wow-delay="0.5s">
                        <div class="b-items__cars-one-img">
                            <img src="/media/284x251/toyota.jpg" alt='toyota'/>
                            ...
                            <div class="row s-noRightMargin">
                                ...
                                <div class="col-md-3 col-xs-12">
                                    <div class="b-items__cars-one-info-price">
                                        ...
                                        <a href="/cars/1" class="btn m-btn ">Remove Favorite<span class="fa fa-remove"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="b-items__cars-one wow zoomInUp" data-wow-delay="0.5s">
                        <div class="b-items__cars-one-img">
                            <img src="/media/284x251/maxima.jpg" alt='maxima'/>
                    ...
                    <div class="b-items__cars-one wow zoomInUp" data-wow-delay="0.5s">
                        <div class="b-items__cars-one-img">
                            <img src="/media/284x251/mersList.jpg" alt='maxima'/>
                            <span class="b-items__cars-one-img-type m-listing">NEW LISTING</span>
                        </div>
                        <div class="b-items__cars-one-info">
                            <form class="b-items__cars-one-info-header s-lineDownLeft">
                                <h2>Mercedes-Benz CLA45 AMG</h2>
