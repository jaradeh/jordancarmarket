        ...
        <div class='row'>
            <div class='col-lg-12 col-xs-12'>
                <div class="col-lg-12 col-xs-12" data-wow-delay="0.5s">
                    <a href="/" class="b-breadCumbs__page"><?= yii::t('app', 'home') ?></a><span class="fa fa-angle-right"></span><a href="/" class="b-breadCumbs__page m-active"><?= yii::t('app', 'Amman Area Showrooms') ?></a>
                </div>
            </div>
...
<section class="b-brands s-shadow" style="padding-top:40px;">
    <div class='container'>
        <div class="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
            <h2 style='margin:0px;'><?= yii::t('app', 'Amman Area Showrooms') ?></h2>
        </div>
    </div>
