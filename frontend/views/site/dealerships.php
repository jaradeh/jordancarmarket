        ...
        <div class='row'>
            <div class='col-lg-12 col-xs-12'>
                <div class="col-lg-12 col-xs-12" data-wow-delay="0.5s">
                    <a href="/" class="b-breadCumbs__page"><?= yii::t('app', 'home') ?></a><span class="fa fa-angle-right"></span><a href="/" class="b-breadCumbs__page m-active"><?= yii::t('app', 'Dealerships') ?></a>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-xs-12" data-waypoint-scroll="true">
                <img src="/media/banners/17_Mercedes_Banner1.jpg" class="img-responsive" style="padding-top: 10px;">
            </div>
        </div>
    </div>
</section><!--b-count-->
...
<section class="b-brands s-shadow" style="padding-top:40px;">
    <div class="container">
        <div class="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
            <h2><?= yii::t('app', 'Dealerships') ?></h2>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">

            <div class="co-xs-12 col-sm-6 col-md-2 col-lg-2 border-dealer">
                <a href='/stores/bmw_cars_fm2dvotdfodlcyz9rlmh0disxvd9g2kl'>
            ...
            <div class="co-xs-12 col-sm-6 col-md-2 col-lg-2 border-dealer-last-child">
                <a href='/stores/bmw_cars_fm2dvotdfodlcyz9rlmh0disxvd9g2kl'>
                    <div class="b-brands__brand wow rotateIn" data-wow-delay="0.5s">
            ...
            <div class="co-xs-12 col-sm-6 col-md-2 col-lg-2 border-dealer-second-row">
                <a href='/stores/bmw_cars_fm2dvotdfodlcyz9rlmh0disxvd9g2kl'>
                    <div class="b-brands__brand wow rotateIn" data-wow-delay="0.5s">
