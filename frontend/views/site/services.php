...
<section class="b-pageHeader" style="background: url(../images/backgrounds/<?php echo $header_image; ?>); ">
    <div class="container">
        <h1 class="wow zoomInLeft" data-wow-delay="0.7s" style="visibility: visible; animation-delay: 0.7s; animation-name: zoomInLeft;">Our Services</h1>
<!--        <div class="b-pageHeader__search wow zoomInRight" data-wow-delay="0.7s" style="visibility: visible; animation-delay: 0.7s; animation-name: zoomInRight;">
            <h3>Read Latest Jordan Car Market Reviews</h3>
        </div>-->
    </div>
</section>
<div class="b-breadCumbs s-shadow">
    <div class="container wow zoomInUp" data-wow-delay="0.7s" style="visibility: visible; animation-delay: 0.7s; animation-name: zoomInUp;">
        <a href="/" class="b-breadCumbs__page">Home</a><span class="fa fa-angle-right"></span><a href="/services" class="b-breadCumbs__page">Our Services</a>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-9 col-xs-12">
                <div class="b-article__main">
                    <div class="b-blog__posts-one">
                        <div class="row m-noBlockPadding">
                            <div class="col-sm-1 col-xs-2">
                                <div class="b-blog__posts-one-author wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;">
                                    <div class="b-blog__posts-one-author-img">

                                    </div>
                                    <div class="b-blog__posts-one-share s-lineDownCenter">SHARE THIS</div>
                            ...
                            <div class="col-sm-11 col-xs-10">
                                <div class="b-blog__posts-one-body">
                                    <header class="b-blog__posts-one-body-head wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;">
                                    ...
                                    <div class="b-blog__posts-one-body-main wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;">
                                        <div class="b-blog__posts-one-body-main-img">
                                            <div class="bx-wrapper" style="max-width: 100%;"><div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 310px;"><ul class="bxslider enable-bx-slider" data-pager-custom="#bx-pager" data-mode="fade" data-pager-slide="false" data-mode-pager="horizontal" data-pager-qty="0" style="width: auto; position: relative;">
                                                        <li style="float: none; list-style: none; position: absolute; width: 742px; z-index: 50; display: block;"><img class="img-responsive" src="media/750x300/blogBig1.jpg" alt="jaguar"></li>
                                                        <li style="float: none; list-style: none; position: absolute; width: 742px; z-index: 0; display: none;"><img class="img-responsive" src="media/750x300/blogBig2.jpg" alt="jaguar"></li>
                                                        <li style="float: none; list-style: none; position: absolute; width: 742px; z-index: 0; display: none;"><img class="img-responsive" src="media/750x300/blogBig3.jpg" alt="jaguar"></li>
                                            ...
                                            <div class="b-blog__posts-one-body-main-img-small" id="bx-pager">
                                                <a href="#" data-slide-index="0" class="active"><img src="media/90x65/smallBlog1.jpg" alt="car"></a>
                                        ...
                                        <p>Et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo con equat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaec cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque <a href="#">laudantium totam rem aperiam, eaque ipsa</a> quae ab illo inventore veritatis quas architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. </p>
                                        <blockquote>
                                            Curabitur libero. Donec facilisis velit eu est. Phasellus cons quat. Aenean vitae quam. Vivamus nunc. Nunc conseq usemd veld metus imperdiet lacinia. In viverra dolor non justo. Proin molest erat inder rhoncus posuere de nibh quam  onsectet uer lectus acwl vulputate ligula lorem dolor. Donec nunc. Suspendisse potent.
                                        </blockquote>
                                        <p>Curabitur libero. Donec facilisis velit eu est. Phasellus cons quat. Aenean vitae quam. Vivamus etdu nunc. Nunc conseq sem velde metus imperdiet lacinia. Cras ornare pretium tortor.<a href="#">Donec sed augue sed nunc rutrum egestas.</a> Bulum ante ipsum mis in faucibus orci luctus et ultrices posuere.</p>
                                    </div>
                                    <div class="b-blog__posts-one-body-why wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;">
                                        <div class="s-lineDownLeft  s-titleLeft">
                                            <div>
                                                <h2 class="s-titleDet">WHY NISSAN maxima is top the line</h2>
                                            </div>
                                        </div>
                                        ...
                                        <ul class="s-list">
                                            <li><span class="fa fa-check"></span>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor </li>
                                            <li><span class="fa fa-check"></span>ncididunt ut labore et dolore magna aliqua. Ut enim ad minim </li>
                                            <li><span class="fa fa-check"></span>Veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea  </li>
                                            <li><span class="fa fa-check"></span>Commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse Billum </li>
                                            <li><span class="fa fa-check"></span>dolore eu fugiat nulla pariatur. Excepteur sint occaecat  </li>
                                            <li><span class="fa fa-check"></span>Mupidatat non proident sunt in culpa qui officia deserun </li>
                                        </ul>
                                        <div class="row">
                                    ...
                                    <div class="b-blog__posts-one-body-tags wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;">
                    ...
                    <div class="b-article__main-related s-shadow">
                        <div class="s-lineDownLeft  s-titleLeft">
                            <div>
                                <h2 class="s-titleDet wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;">More Related Articles</h2>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="row">
                    ...
                    <div class="b-article__main-comments">
                        <div class="s-lineDownLeft  s-titleLeft">
                            <div class="wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;">
                                <h2 class="s-titleDet">COMMENTS</h2>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="b-article__main-comments-one wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;">
                                    ...
                                    <div class="b-article__main-comments-one-text">
                                        <header class="b-article__main-comments-one-text-head">
                                            ...
                                            <div class="b-article__main-comments-one-text-head-date">
                                                ...
                                                <span>Posted at 12:25 AM</span>
                                            </div>
                                            <a class="b-article__main-comments-one-text-head-answer  pull-right" href="#"><span class="fa fa-long-arrow-left"></span></a>
                                        </header>
                                        <p>
                                            In eget dolor. Lorem ipsum dolor sit amet consectetuer adipiscing elit. Ut ornare cursus nibh. Sed lorem volutpat purus scel erisque dapibus. Etiam adipiscing ante nec nibh. In in felis in metus mollis blandit.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12">
                                <div class="b-article__main-comments-one m-second wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;">
                                    <div class="b-article__main-comments-one-person">
                                        <div class="b-blog__posts-one-author-img m-woomen"></div>
                                    </div>
                                    <div class="b-article__main-comments-one-text">
                                        <header class="b-article__main-comments-one-text-head">
                                            <h6>Martina Kathrine</h6>
                                            <div class="b-article__main-comments-one-text-head-date">
                                                <span>30 MAY 2015</span>
                                                <span>Posted at 12:25 AM</span>
                                            </div>
                    ...
                    <div class="b-article__main-add wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;">
                        <div class="s-lineDownLeft  s-titleLeft">
                            <div>
                                <h2 class="s-titleDet">ADD A REPLY</h2>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <form action="/" method="POST">
                            ...
                            <button type="submit" class="btn m-btn">SEND COMMENT<span class="fa fa-angle-right"></span></button>
                        </form>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-xs-12">
                <aside class="b-blog__aside">
                    <form class="b-blog__aside-search wow zoomInUp" data-wow-delay="0.5s" action="/" method="post" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;">
                        <div>
                    ...
                    <div class="b-blog__aside-text wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;">
                        <header class="s-lineDownLeft">
                    ...
                    <div class="b-blog__aside-reviews wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;">
                        <header class="s-lineDownLeft">
                    ...
                    <div class="b-blog__aside-archives wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;">
                        <header class="s-lineDownLeft">
                            <h2 class="s-titleDet">ARCHIVES</h2>
                        </header>
                        <nav>
                            <ul class="b-blog__aside-categories-list">
                                <li><a href="#">April 2015</a></li>
                                <li><a href="#">March 2015</a></li>
                                <li class="m-active"><a href="#">February 2015</a></li>
                                <li><a href="#">January 2105</a></li>
                            </ul>
                        </nav>
                    </div>
