...
if ($lang_id == 1) {
    $slider_image_style = "";
    $slider_container_float = "left";
    $slider_container_text_align = "left";
} else {
    $slider_image_style = "-webkit-transform: scaleX(-1);transform: scaleX(-1);";
    $slider_container_float = "right";
    $slider_container_text_align = "right";
}
$i = 0;
?>
<section class="b-search ">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12  b-search-secion">
                <div class="car-search-tool-container b-search__main-type wow zoomInUp" data-wow-delay="0.3s">

                    <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1  home_page_search_container_black_background">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding" >

                                <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 here'>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 no_padding">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 no_padding">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding">
                                                <div class="content_wrapper">
                                                    <label class="color_dark form_lable" for="text_search" style='color:#fff !important;'>  Car Year</label>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 no_padding">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding">
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding" >
                                                    <div class="content_wrapper">
                                                        <label class="color_dark form_lable" for="text_search" style='color:#fff !important;'> Price</label>
                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"></div>
                                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 no_padding">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 no_padding">
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding">
                                                    <div class="content_wrapper" style="margin-left:3px;margin-top: 25px;">
                                                        <div id="home_search_input_button_submit" class="button red pull-right" style="width: 100%; margin-bottom: 10px; padding: 0px; padding-top: 11px; padding-bottom: 10px;"> <b>Search</b> </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding" id="home_search_advanced_div_wrapper" style="display: none;">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 no_padding">
                                            <h4 style='color:#fff;'>Select vehicle type</h4>
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                <div class="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
                                                    ...
                                                    <h2 style="margin:0px;color:#fff;">Vehicle Features</h2>
                                                </div>
                                            </div>
                                            <div  class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <?php foreach ($select_car_main_features_category as $cars_main_features => $cars_main_feature) { ?>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    <label class="home_advanced_search_category_label home_page_custome_search_header_checkbox_lable" style='color:#fff;'><?php echo $cars_main_feature->name ?></label>
                                                </div>
                                                <?php foreach ($select_car_features_category as $car_features_category => $feature_by_catid) { ?>
                                                    <?php if ($feature_by_catid->cat_id == $cars_main_feature->id) { ?>
                                                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                            <label class="container_check label_for_checkbox_home_advaced_search" for="car_feature_by_id_<?php echo $feature_by_catid->id ?>"  style='color:#fff;'>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding" style='margin-top:5px;'>
                            <div class='col-xs-12 col-sm-12 col-md-6 col-lg-6 no_padding'>
                                <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding'>
                                    <div class='more_options_wrapper' style="padding-bottom:5px;">
...
<section class="section-carTypes">
    <div class="container">
        <!--<h3 class="s-titleBg wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;"><?= yii::t('app', 'THE WORLD OF AUTOS') ?></h3><br>-->
        <!--<h2 class="s-title wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;"><?= yii::t('app', 'SPECIFY YOUR SEARCH') ?></h2>-->
            ...
            <div class="col-sm-4 col-xs-12">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="b-world__item j-item wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">
                        ...
                        <a href="/amman-show-rooms"><h2><?= yii::t('app', 'Amman Area Showrooms') ?></h2></a>
                        <br />
                    </div>
                </div>
                ...
                <?php $counter_1 = 0; ?>
                <?php foreach ($select_stores as $stores => $store) { ?>
                    <div class='col-xs-6 col-sm-12 col-md-6 col-lg-6'>
                        <?php if ($store->id == 2) { ?>
                            <a href="/stores/<?php echo $store->slug ?>" class="Trending__block new_service_provider_label">
                            <?php } else { ?>
                                <a href="/stores/<?php echo $store->slug ?>" class="Trending__block ">
                                <?php } ?>

                                <div class="Trending__icon">
                                    <center>
                                        <img src="/media/stores_logo_150x150/<?php echo $store->path ?>" alt="<?php echo $store->name ?>" style='width:36px;height: 33px;'>
                                    </center>
                                </div>

                                <div class="Trending__tag"><?php echo mb_substr($store->name, 0, 16) . " ..."; ?></div>
                            </a>
                    </div>
                    <?php $counter_1++; ?>
                <?php } ?>
                <div class='col-xs-6 col-sm-12 col-md-6 col-lg-6'>
                    <a href="/amman-show-rooms" class="Trending__block ">
                        <div class="Trending__icon">
                            <center>
                                <img src="/media/stores_logo_150x150/villa-for-sale.png" alt="Jordan Car Market" style='width:36px;height: 33px;'>
                            </center>
                        </div>

                        <div class="Trending__tag">View all stores</div>
                    </a>
                </div>
            </div>
            ...
            <div class="col-sm-4 col-xs-12">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="b-world__item j-item wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">
                        ...
                        <a href="/dealerships"><h2><?= yii::t('app', 'Dealerships') ?></h2></a>
                        <br />
                    </div>
                </div>


                <?php foreach ($select_stores_dealership as $dealers => $dealer) { ?>
                    <div class='col-xs-6 col-sm-12 col-md-6 col-lg-6'>
                        <a href="/stores/<?php echo $dealer->slug ?>" class="Trending__block ">
                            <div class="Trending__icon">
                                <center>
                                    <img src="/media/stores_logo_150x150/<?php echo $dealer->path ?>" alt="<?php echo $dealer->name ?>" style='height: 33px;'>
                                </center>
                            </div>

                            <div class="Trending__tag"><?php echo mb_substr($dealer->name, 0, 16) . " ..."; ?></div>
                        </a>
                    </div>
                <?php } ?>
                <div class='col-xs-6 col-sm-12 col-md-6 col-lg-6'>
                    <a href="/dealerships" class="Trending__block ">
                        <div class="Trending__icon">
                            <center>
                                <img src="/media/stores_logo_150x150/villa-for-sale.png" alt="Jordan Car Market" style='width:36px;height: 33px;'>
                            </center>
                        ...
                        <div class="Trending__tag">View all dealers</div>
                    </a>
                </div>
            </div>
            ...
            <div class="col-sm-4 col-xs-12">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="b-world__item j-item wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">
                        ...
                        <a href="/free-zone"><h2><?= yii::t('app', "Free Zone's Cars") ?></h2></a>
                        <br />
                    </div>
                </div>
                ...
                <?php } ?>
                <div class='col-xs-6 col-sm-12 col-md-6 col-lg-6'>
                    <a href="/free-zone" class="Trending__block ">
                        <div class="Trending__icon">
                            <center>
                                <img src="/media/stores_logo_150x150/villa-for-sale.png" alt="Jordan Car Market" style='width:36px;height: 33px;'>
                            </center>
...
<section  id="b-count">
    <center>
        <div>
            <h3 class="s-titleBg wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;"><?= yii::t('app', 'EVERYTHING YOU NEED') ?></h3><br>
            <h2 class="s-title wow zoomInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomInUp;"><?= yii::t('app', 'TO KNOW OUR AUTOS WORLD') ?></h2>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12 percent-blocks m-main" style="background-color: transparent;" data-waypoint-scroll="true">
                <div class="row">
                    <?php if ($lang_id == 1) { ?>
                        <div class="col-sm-4 col-xs-4">
                            <div class="b-count__item">
                                ...
                                <div class="chart" data-percent="5472">
                                    <h2  class="percent">5472</h2>
                                </div>
                                <h5>Listed show rooms</h5>
                            </div>
                        </div>
                        <div class="col-sm-4 col-xs-4">
                            <div class="b-count__item">
                                ...
                                <div class="chart" data-percent="3864">
                                    <h2  class="percent">3864</h2>
                                </div>
                        ...
                        <div class="col-sm-4 col-xs-4">
                            <div class="b-count__item">
                                ...
                                <div class="chart" data-percent="102">
                                    <h2  class="percent">102</h2>
                                </div>
                                <h5>Cars sold</h5>
                            </div>
                        </div>
                        <!--                        <div class="col-sm-3 col-xs-6">
                                                    <div class="b-count__item j-last">
                                                        ...
                                                        <div class="chart" data-percent="591">
                                                            <h2  class="percent">591</h2>
                                                        </div>
                                                        <h5>Daily Listing Views</h5>
                                                    </div>
                                                </div>-->
                    <?php } else { ?>
                        <div class="col-sm-3 col-xs-6">
                            <div class="b-count__item j-last">
                                ...
                                <h5><?= yii::t('app', 'Daily Listing Views') ?></h5>
                            </div>
                        </div>
                        <div class="col-sm-3 col-xs-6">
                            <div class="b-count__item">
                                ...
                                <h5><?= yii::t('app', 'Daily New listing') ?></h5>
                            </div>
                        </div>
                        <div class="col-sm-3 col-xs-6">
                            <div class="b-count__item">
                                ...
                                <h5><?= yii::t('app', 'HAPPY CUSTOMERS') ?></h5>
                            </div>
                        </div>
                        <div class="col-sm-3 col-xs-6">
                            <div class="b-count__item">
...
<section class="b-brands s-shadow" style="background: #fff">
