        ...
        <div class='container'>
            <div class='row'>
                <div class='col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1'>
                    ...
                    <div class="stepwizard" id='slide_page_div'>
                        <div class="stepwizard-row setup-panel">
                            <div class="stepwizard-step col-xs-2"> 
                                <a href="javascript:void(0)" type="button" id='step_1_circle' class="btn btn-danger btn-circle">1</a>
                                <p><small>General</small></p>
                            </div>
                            <div class="stepwizard-step col-xs-2"> 
                                <a href="javascript:void(0)" type="button" id='step_2_circle' class="btn btn-default btn-circle" disabled="disabled">2</a>
                                <p><small>Description</small></p>
                            </div>
                            <div class="stepwizard-step col-xs-2"> 
                                <a href="javascript:void(0)" type="button" id='step_3_circle' class="btn btn-default btn-circle" disabled="disabled">3</a>
                                <p><small>Image(s)</small></p>
                            </div>
                            <div class="stepwizard-step col-xs-2"> 
                                <a href="javascript:void(0)" type="button" id='step_4_circle' class="btn btn-default btn-circle" disabled="disabled">4</a>
                                <p><small>Inspection</small></p>
                            </div>
                            <div class="stepwizard-step col-xs-2"> 
                                <a href="javascript:void(0)" type="button" id='step_5_circle' class="btn btn-default btn-circle" disabled="disabled">5</a>
                                <p><small>Confirmation</small></p>
                            </div>
                            <div class="stepwizard-step col-xs-2"> 
                                <a href="javascript:void(0)" type="button" id='step_6_circle' class="btn btn-default btn-circle" disabled="disabled">6</a>
                        ...
                        <div class="panel-body">
                            ...
                            <div class='col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1'>
                                <div class='add_fields_wrapper'>
                                    ...
                                    <footer class="b-items__aside-main-footer" style='text-align: right;'>
                                        <div class="button red" id='next_btn_first'> Next </div>
                                    </footer>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-primary setup-content" id="step-2">
                        ...
                        <div class="col-sm-6 ">
                            <ul class="tags seperator_content">
                                <li><a href="#">Description & Status</a></li>
                            </ul>
                        </div>
                        <div class="panel-body">
                            <div class='col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1'>
                                <div class='add_fields_wrapper'>
                                    <div class="form-group">
                                        <?= $form->field($model, 'name')->textInput(['maxlength' => true, 'placeholder' => 'Ad Name (eg : Ford Fusion)']) ?>
                                        <?= $form->field($model, 'title')->textInput(['maxlength' => true, 'placeholder' => 'Ad Title (eg : Fully loaded Fusion for sale)']) ?>
                                        <?=
                        ...
                        <div class="col-sm-6 ">
                            <ul class="tags seperator_content">
                                <li><a href="#">Select Features</a></li>
                            </ul>
                        </div>
                        <div class="panel-body">
                            <div class='col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1'>
                        ...
                        <div class="col-sm-6 ">
                            <ul class="tags seperator_content">
                                <li id="error_slide_section_two"><a href="#">Select Specs</a></li>
                            </ul>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class='col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1'>
                                ...
                                <div class="col-md-12">
                                    <footer class="b-items__aside-main-footer" style='text-align: right;'>
                                        <div class="button red pull-left" id='previous_btn_second'> Previous </div>
                                        <div class="button red pull-right" id='next_btn_second'> Next </div>
                                    </footer>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-primary setup-content" id="step-3">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class='col-xs-12 col-sm-12 col-md-4 col-md-offset-1 col-lg-4 col-lg-offset-1' id="show_images_slide">
                                    <div class='add_fields_wrapper'>
                                        <div class="form-group">
                                            <div class="panel panel-info" >
                                                ...
                                                <div id="div_for_main_image_select_two" style="display: none;">
                                                    ...
                                                    <div class="panel-footer text-center select_image_footer_custom">
                                                        <div class="btn-group">
                                                            <label class="btn btn-info btn-file">
                                                                ...
                                                                <input type="file" id="select_main_images_input_two" name="CarsImages[images][]" multiple="" accept="image/*" style="display: none;">
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12' id="images_big_wrapper" style="display: none;">
                                    ...
                                    <div class='add_fields_wrapper'>
                                        <div class="form-group" id="populate_images_div">
                                ...
                                <div class='col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1'>
                                    <footer class="b-items__aside-main-footer" style='text-align: right;'>
                                        <div class="button red pull-left" id='previous_btn_third'> Previous </div>
                                        <div class="button red pull-right" id='next_btn_third'> Next </div>
                                    </footer>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-primary setup-content" id="step-4">
                        ...
                        <div class="col-sm-6">
                            <ul class="tags seperator_content">
                                <li><a href="#" id='insepection_section_scroll_img'>Upload Inspection Image</a></li>
                            </ul>
                        </div>
                        <div class="col-sm-12"></div>
                        <div class="panel-body" id='show_inspection_image_slide'>
                            ...
                            <div class="row">
                                ...
                                <div class='col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1'>
                                    <footer class="b-items__aside-main-footer" style='text-align: right;'>
                                        <div class="button red pull-left" id='previous_btn_four'> Previous </div>
                                        <div class="button red pull-right" id='next_btn_four'> Next </div>
                                    </footer>
                                </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class='col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2'>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="panel panel-info" >
                                                ...
                                                <table class="table table-responsive table-hover">
                                                    <tr>
                                                        <th class='confirm_table_th'><div class="confirm_label_holder_div"><i class="fa fa-check-circle text-success"></i> Car Make</div></th>
                                                        <td class='confirm_table_td'>
                                                            <div class="col-sm-12 no_padding">
                                                                <input type="text" class="form-control confirm_input_holder_text" id="confirm_input_make" value="test">
                                                                <label class='confirm_edit_icon_on_input_text' for='confirm_input_make'>
                                                    ...
                                                    <tr>
                                                        <th class='confirm_table_th'><div class="confirm_label_holder_div"><i class="fa fa-check-circle text-success"></i> Car Model</div></th>
                                                        <td class='confirm_table_td'>
                                                            <div class="col-sm-12 no_padding">
                                                                <input type="text" class="form-control confirm_input_holder_text" id="confirm_input_model" value="test">
                                                                <label class='confirm_edit_icon_on_input_text' for='confirm_input_model'>
                                                                    <i class="fa fa-edit text-info "></i>
                                                                </label>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th class='confirm_table_th'><div class="confirm_label_holder_div"><i class="fa fa-check-circle text-success"></i> Ad Name</div></th>
                                                        <td class='confirm_table_td'>
                                                            <div class="col-sm-12 no_padding">
                                                                <input type="text" class="form-control confirm_input_holder_text" id="confirm_input_name" value="test">
                                                                <label class='confirm_edit_icon_on_input_text' for='confirm_input_name'>
                                                                    <i class="fa fa-edit text-info "></i>
                                                                </label>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th class='confirm_table_th'><div class="confirm_label_holder_div"><i class="fa fa-check-circle text-success"></i> Ad Title</div></th>
                                                        <td class='confirm_table_td'>
                                                            <div class="col-sm-12 no_padding">
                                                                <input type="text" class="form-control confirm_input_holder_text" id="confirm_input_title" value="test">
                                                                <label class='confirm_edit_icon_on_input_text' for='confirm_input_title'>
                                                                    <i class="fa fa-edit text-info "></i>
                                                                </label>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th class='confirm_table_th'><div class="confirm_label_holder_div"><i class="fa fa-check-circle text-success"></i> Car Price</div></th>
                                                        <td class='confirm_table_td'>
                                                            <div class="col-sm-12 no_padding">
                                                                <input type="text" class="form-control confirm_input_holder_text" id="confirm_input_price" value="test">
                                                                <label class='confirm_edit_icon_on_input_text' for='confirm_input_price'>
                                                                    <i class="fa fa-edit text-info "></i>
                                                                </label>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th class='confirm_table_th'><div class="confirm_label_holder_div"><i class="fa fa-check-circle text-success"></i> Car Year</div></th>
                                                        <td class='confirm_table_td'>
                                                            <div class="col-sm-12 no_padding">
                                                                <input type="text" class="form-control confirm_input_holder_text" id="confirm_input_year" value="test">
                                                                <label class='confirm_edit_icon_on_input_text' for='confirm_input_year'>
                                                                    <i class="fa fa-edit text-info "></i>
                                                                </label>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th class='confirm_table_th'><div class="confirm_label_holder_div"><i class="fa fa-check-circle text-success"></i> Car Milage</div></th>
                                                        <td class='confirm_table_td'>
                                                            <div class="col-sm-12 no_padding">
                                                                <input type="text" class="form-control confirm_input_holder_text" id="confirm_input_milage" value="test">
                                                                <label class='confirm_edit_icon_on_input_text' for='confirm_input_milage'>
                                                                    <i class="fa fa-edit text-info "></i>
                                                                </label>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th class='confirm_table_th'><div class="confirm_label_holder_div"><i class="fa fa-check-circle text-success"></i> Body Type</div></th>
                                                        <td class='confirm_table_td'>
                                                            <div class="col-sm-12 no_padding">
                                                                <input type="text" class="form-control confirm_input_holder_text" id="confirm_input_body_type" value="test">
                                                                <label class='confirm_edit_icon_on_input_text' for='confirm_input_body_type'>
                                                                    <i class="fa fa-edit text-info "></i>
                                                                </label>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th class='confirm_table_th'><div class="confirm_label_holder_div"><i class="fa fa-check-circle text-success"></i> Interior Type</div></th>
                                                        <td class='confirm_table_td'>
                                                            <div class="col-sm-12 no_padding">
                                                                <input type="text" class="form-control confirm_input_holder_text" id="confirm_input_interior_type" value="test">
                                                                <label class='confirm_edit_icon_on_input_text' for='confirm_input_interior_type'>
                                                                    <i class="fa fa-edit text-info "></i>
                                                                </label>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th class='confirm_table_th'><div class="confirm_label_holder_div"><i class="fa fa-check-circle text-success"></i> Car Engine</div></th>
                                                        <td class='confirm_table_td'>
                                                            <div class="col-sm-12 no_padding">
                                                                <input type="text" class="form-control confirm_input_holder_text" id="confirm_input_engine" value="test">
                                                                <label class='confirm_edit_icon_on_input_text' for='confirm_input_engine'>
                                                                    <i class="fa fa-edit text-info "></i>
                                                                </label>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th class='confirm_table_th'><div class="confirm_label_holder_div"><i class="fa fa-check-circle text-success"></i> Exterior Color</div></th>
                                                        <td class='confirm_table_td'>
                                                            <div class="col-sm-12 no_padding">
                                                                <input type="text" class="form-control confirm_input_holder_text" id="confirm_input_exterior_color" value="test">
                                                                <label class='confirm_edit_icon_on_input_text' for='confirm_input_exterior_color'>
                                                                    <i class="fa fa-edit text-info "></i>
                                                                </label>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th class='confirm_table_th'><div class="confirm_label_holder_div"><i class="fa fa-check-circle text-success"></i> Interior Color</div></th>
                                                        <td class='confirm_table_td'>
                                                            <div class="col-sm-12 no_padding">
                                                                <input type="text" class="form-control confirm_input_holder_text" id="confirm_input_interior_color" value="test">
                                                                <label class='confirm_edit_icon_on_input_text' for='confirm_input_interior_color'>
                                                                    <i class="fa fa-edit text-info "></i>
                                                                </label>
                                                            </div>
                                                        </td>
                                    ...
                                    <footer class="b-items__aside-main-footer" style='text-align: right;'>
                                        <div class="button red pull-left" id='previous_btn_five'> Previous </div>
                                        <div class="button red pull-right" id='next_btn_five'> Confirm </div>
                                    </footer>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-primary setup-content" id="step-6">
                        ...
                        <div class="col-sm-6 ">
                            <ul class="tags seperator_content" style='padding-bottom:70px;'>
                                <li><a href="#">Choose Ad Plan</a></li>
                            </ul>
                        </div>
                        <div class="panel-body">
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-footer">
                                            <a href="javascript:void(0)" class="button register_button submit_final_car_add" id='submit_final_car_add' role="button">Select Free Plan</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-4">
                                    <div class="panel panel-success">
                                        ...
                                        <div class="panel-footer">
                                            <a href="javascript:void(0)" class="button register_button submit_final_car_add" id='submit_final_car_add' role="button">Select Silver Plan</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-4">
                                    <div class="panel panel-info">
                                        ...
                                        <div class="panel-footer">
                                            <a href="javascript:void(0)" class="button register_button submit_final_car_add" id='submit_final_car_add' role="button">Select Gold Plan</a>
                                        </div>
                                    </div>
                                </div>
                                <div class='col-sm-12'>
                                    <footer class="b-items__aside-main-footer" style='text-align: right;'>
                                        <div class="button red pull-left" id='previous_btn_six'> Previous </div>
                                    </footer>
                                </div>
                            </div>
                        </div>
                ...
                <div class='col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1'>
                    ...
                    <div class="stepwizard" id='slide_page_div'>
                        <div class="stepwizard-row setup-panel">
                            ...
                            <div class="stepwizard-step col-xs-2"> 
                                <a href="javascript:void(0)" type="button" id='step_5_circle' class="btn btn-default btn-circle" disabled="disabled">5</a>
                                <p><small>تثبيت</small></p>
                            </div>
                            <div class="stepwizard-step col-xs-2"> 
                                <a href="javascript:void(0)" type="button" id='step_4_circle' class="btn btn-default btn-circle" disabled="disabled">4</a>
                                <p><small>الفحص</small></p>
                            </div>
                            <div class="stepwizard-step col-xs-2"> 
                                <a href="javascript:void(0)" type="button" id='step_3_circle' class="btn btn-default btn-circle" disabled="disabled">3</a>
                                <p><small>الصور</small></p>
                            </div>
                            <div class="stepwizard-step col-xs-2"> 
                                <a href="javascript:void(0)" type="button" id='step_2_circle' class="btn btn-default btn-circle" disabled="disabled">2</a>
                                <p><small>وصف السيارة</small></p>
                            </div>
                            <div class="stepwizard-step col-xs-2"> 
                                <a href="javascript:void(0)" type="button" id='step_1_circle' class="btn btn-danger btn-circle">1</a>
                                <p><small>معلومات عامة</small></p>
                            </div>
                        </div>
                    </div>

                    <?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data', 'id' => 'add_car_form']]); ?>

                    <div class="panel panel-primary setup-content" id="step-1">
                        <div class="panel-heading add_car_big_header">
                            <h3 class="panel-title"><span class='header_left_text'>!اضف سيارتك للبيع مجانا</span></h3>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class='col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1'>
                                <div class='add_fields_wrapper'>
                                    <div class="form-group">
                                        <span class='required_star red_color'>*</span><label class="control-label">نوع السيارة</label>
                                        <div class="dropdown">
                                            <input type="text" placeholder="اختر نوع السيارة" class="btn btn-default dropdown-toggle  custom_dropdown add_field_custome car_make_name" required="required" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                            <input type="hidden" id="make_id_for_post_final" name='Cars[make_id]' value="">
                                            <img class="select_main_image" id="select_image" src="/images/logo/add_field_logo.png">
                                            <span class="fa fa-caret-down red_color pull-right dropdown_icon_for_input_make" id="dropdown_icon_for_input_make"></span>

                                            <ul class="dropdown-menu drop_down_enable_scroll">
                                                <li class="dropdown-header">اختر النوع</li>
                                                <?php foreach ($make_details as $car_make => $make) { ?>
                                                    <?php
                                                    $i++;
                                                    ?>
                                    ...
                                    <div class="form-group">
                                        <span class='required_star red_color'>*</span><label class="control-label">موديل السيارة</label>
                                        <div class="dropdown">
                                            <input type="text" placeholder="اختر موديل السيارة" id="dropdownMenu2" value='' class="btn btn-default dropdown-toggle  custom_dropdown add_field_custome car_make_name" required="required" type="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" disabled="">
                                            <input type="hidden" id="model_id_for_post_final" name="Cars[model_id]" value="" >
                                            <img class="select_main_image" src="/images/logo/sport-tuning-car-auto-model-512.png">
                                            <span class="fa fa-caret-down red_color pull-right dropdown_icon_for_input_make" id="dropdown_icon_for_input_make"></span>
                                            <ul class="dropdown-menu drop_down_enable_scroll" id="add_model_list">
                                                <li class="dropdown-header">اختر الموديل</li>
                                    ...
                                    <div class="form-group">
                                        <span class='required_star red_color'>*</span><label class="control-label">موقع السيارة</label>
                                        <div class="dropdown">
                                            <input type="text" placeholder="اختر موقع السيارة" id="car_location_input" value='' class="btn btn-default dropdown-toggle  custom_dropdown add_field_custome car_make_name" required="required" type="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" >
                                            <input type="hidden" id="location_id_for_post_final" name="Cars[location]" value="" >
                                            <i class='select_main_image fa fa-globe icon_location_globe' style='margin-right: 15px;'></i>
                                            <span class="fa fa-caret-down red_color pull-right dropdown_icon_for_input_make" id="dropdown_icon_for_input_make"></span>
                                            <ul class="dropdown-menu drop_down_enable_scroll" id="car_location_list">
                                                <li class="dropdown-header">اختر الموقع</li>
                                                <li class="select_main_location_li" id="1">
                                                    <div class="select_model_li">
                                                        <span class="car_make_name " id="car_location_li_name_1"> عمان
                                                        </span>
                                                ...
                                                <li class="select_main_location_li" id="2">
                                                    <div class="select_model_li">
                                                        <span class="car_make_name" id="car_location_li_name_2"> وكالة
                                                        </span>
                                                        <i class='fa fa-globe' style='margin-left: 15px;'></i>
                                                    </div>
                                                </li>
                                    ...
                                    <footer class="b-items__aside-main-footer" style='text-align: left;'>
                                        <div class="button red" id='next_btn_first'> التالي </div>
                                    </footer>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 no_padding">
                                    <div class="form-group">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <input type="hidden" id="car_exterior_color_for_post_final" value="" name="Cars[exterior_color]"  value="">
                                            <img class="select_main_image " id="car_exterior_color_dropdown_image" src="/images/elements/Color_wheel.png">
                                            <span class="fa fa-caret-down red_color pull-right dropdown_icon_for_input_make create_car_make_logo_image" id="dropdown_icon_for_input_body_type "></span>
                                            <ul class="dropdown-menu drop_down_enable_scroll">
                                                <li class="dropdown-header">Select Car Exterior Color</li>
                                                <?php foreach ($select_colors as $colors_details => $colors) { ?>
                                                    <li class="select_exterior_li" id="<?php echo $colors->id ?>">
                                                        <div class='select_make_li'>
                                                            <img id='color_img_<?php echo $colors->id ?>' src="/images/elements/<?php echo $colors->path ?>" class='custome_dropdown_img shadow_box  ' >
                                                            <span class='car_make_name' id='color_span_<?php echo $colors->id ?>'>
                                                                <?php echo $colors->name ?>
                                                            </span>
                                                        </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu drop_down_enable_scroll">
                                                ...
                                                <?php foreach ($select_colors as $colors_details => $colors) { ?>
                                                    <li class="select_interior_li" id="<?php echo $colors->id ?>">
                                                        <div class='select_make_li'>
                                                            <img id='color_interior_img_<?php echo $colors->id ?>' src="/images/elements/<?php echo $colors->path ?>" class='custome_dropdown_img shadow_box ' >
                                                            <span class='car_make_name' id='interior_color_span_<?php echo $colors->id ?>'>
                                                                <?php echo $colors->name ?>
                                                            </span>
                                                        </div>
