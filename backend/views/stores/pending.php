                        ...
                        <?php foreach ($model as $stores => $store) { ?>
                            <tr data-key="1">
                                ...
                                <td>
                                        ...
                                        <div class="margin">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a href="/backend/web/stores/changelive/<?php echo $store->id ?>" title="Live" aria-label="Live" data-pjax="0" data-confirm="Are you sure you want to change this item to Live ?" data-method="post"><span class="glyphicon glyphicon-signal text-success"></span> Live</a></li>
                                    ...
                                    <?php } else { ?>
                                        <a href="/backend/web/stores/changelive/<?php echo $store->id ?>" title="Live" aria-label="Live" data-pjax="0" data-confirm="Are you sure you want to change this item to Live ?" data-method="post"><span class="glyphicon glyphicon-signal text-success"></span> Live</a>
                                        <br />
                                        <a href="/backend/web/stores/changepending/<?php echo $store->id ?>" title="Pending" aria-label="Pending" data-pjax="0" data-confirm="Are you sure you want to change this item to pending ?" data-method="post"><span class="glyphicon glyphicon-warning-sign text-warning"></span> Pending</a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php } ?>
